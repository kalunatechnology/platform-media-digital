...
<div class="ml-sidebar">
    <nav class="navbar navbar-custom">
        <span>Edit Data Artikel Sudah Publish</span>
                                            ...
                                            <div id="add-data-paket" class="card">
                                                ...
                                                <div class="card-header pb-2">
                                                    <div class="d-flex align-items-center">
                                                        <h4 class="card-title">Edit Data Artikel Sudah Publish</h4>
                                                    </div>
                                                </div>
                                                <div class="card-body">
                                                    <form action="{{ url('/backoffice/edit_publish/' . $data->id) }}" method="post" enctype="multipart/form-data">
                                                        @method('put')
                                                        @csrf
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="form-control-label">Artikel Terbit</label>
                                                                    <input name="date_start" class="form-control" type="text"
                                                                        value="{{ \Carbon\Carbon::parse($data['date_start'])->translatedFormat('d F Y') }}" readonly>
                                                                </div>
                                                                
                                                                <div class="form-group">
                                                                    <label class="form-control-label">Artikel Habis Masa Penayangan</label>
                                                                    <input name="date_end" class="form-control" type="text"
                                                                        value="{{ \Carbon\Carbon::parse($data['date_end'])->translatedFormat('d F Y') }}" readonly>
                                                                </div>
                                                                <div class="form-group">
                                                            ...
                                                            <div class="d-flex justify-content-end mt-4">
                                                                <a href="{{ url('/backoffice/published_editor') }}" class="btn btn-sm bg-warning mx-1 text-black">
                                                                    Cancel
                                                                </a>
