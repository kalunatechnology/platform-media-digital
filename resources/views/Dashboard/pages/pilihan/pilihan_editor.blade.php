                        ...
                        <div class="container">
                            <main class="d-flex flex-column gap-3 grow">
                                <section class="d-flex gap-2 items-center justify-content-between">
                                    <div style="color: red">1. Centang kotak di samping artikel yang ingin Anda pilih sebagai artikel pilihan. <br> 2. Kemudian klik simpan pilihan editor untuk menyimpan pilihan</div>
                                </section>
                                <div class="d-flex align-items-center ml-auto">
                                    <form method="GET" action="{{ url('/backoffice/pilihan_editor') }}" class="form-search">
                                        <label for="search">
                                ...
                                <form action="{{ route('artikel.set_editor_choice') }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <section class="mt-4">
                                        <div class="card mb-4">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    <input type="checkbox" name="editor_pick[]" value="{{ $artikel->id }}" 
                                    ...
                                    <div class="mt-3">
                                        <button type="submit" class="btn btn-success">Simpan Pilihan Editor</button>
                                    </div>
                                </form>
                            </main>
                        </div>
