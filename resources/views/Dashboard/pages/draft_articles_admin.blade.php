...
<div class="ml-sidebar">
    ...
    <div class="content">
        ...
        <!-- Search Bar -->
        <form method="GET" action="{{ url('/backoffice/draft_articles_admin') }}" class="form-search">
            <label for="search">
        ...
        <div class="keterangan">
            <p>*Komunikasikan dengan admin terkait pengecekan artikel.</p>
        </div>
        <br><br>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $artikel->title }}</td>
                                <td class="d-flex">
                                    <a href="/backoffice/preview_draft_admin/{{ $artikel->id }}"
