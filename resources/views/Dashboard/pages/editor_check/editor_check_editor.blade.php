...
<div class="ml-sidebar">
    ...
    <div class="content">
        ...
        <div class="card total-timses-card">
            <div class="card-body">
                <h3>Data Artikel yang Sudah Anda Cek</h3>
        ...
        <!-- Search Bar -->
        <form method="GET" action="{{ url('/backoffice/editor_check_editor') }}" class="form-search">
            <label for="search">
        ...
        <div class="keterangan">
            <p>
                1. Anda bisa melihat preview lagi jika dibutuhkan. <br>
                2. Jika anda ingin melakukan pengeditan lagi, anda bisa menekan tombol edit.
            </p>
        </div>
        <br><br>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="d-flex">
                                    ...
                                    <a href="/backoffice/edit_editor_check/{{ $artikel->id }}"
