...
<div class="ml-sidebar">
    ...
    <div class="content">
        ...
        <div class="card total-timses-card">
            <div class="card-body">
                <h3>Data Artikel {{ $card['username'] }} Lolos Editor</h3>
        ...
        <!-- Search Bar -->
        <form method="GET" action="{{ url('/backoffice/editor_check') }}" class="form-search">
            <label for="search">
        ...
        <div class="keterangan">
            <p>1. Admin sedang meninjau artikel untuk diterbitkan. <br>
                2. Anda akan dihubungi admin terkait masa tayang artikel anda.
            </p>
        </div>
        <br><br>
