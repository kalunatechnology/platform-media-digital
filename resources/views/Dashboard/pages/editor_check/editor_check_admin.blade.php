...
<div class="ml-sidebar">
    ...
    <div class="content">
        ...
        <div class="card total-timses-card">
            <div class="card-body">
                <h3>Data Artikel Sudah Pengecekan Editor</h3>
        ...
        <!-- Search Bar -->
        <form method="GET" action="{{ url('/backoffice/editor_check_admin') }}" class="form-search">
            <label for="search">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="publishModalLabel">Konfirmasi Publish Artikel</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>
                                            <form action="{{ url('/backoffice/artikel/' . $artikel->id . '/publish') }}" method="POST">
                                                @csrf
                                                @method('PUT')
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="date_end" class="form-label">Tanggal Artikel Berakhir Masa Publish</label>
