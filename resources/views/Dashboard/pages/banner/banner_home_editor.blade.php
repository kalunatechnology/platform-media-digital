...
<div class="ml-sidebar">
    <nav class="navbar navbar-custom">
        <span class="title-page">Banner Home Editor</span>
                        ...
                        <div class="container">
                            <main class="d-flex flex-column gap-3 grow">
                                <section class="d-flex gap-2 items-center justify-content-between">
                                    <div style="color: red">1. Centang kotak di samping artikel yang ingin Anda pilih sebagai artikel banner di home. <br> 2. Kemudian klik simpan pilihan editor untuk menyimpan pilihan</div>
                                </section>
                                <div class="d-flex align-items-center ml-auto">
                                    <form method="GET" action="{{ url('/backoffice/banner_home_editor') }}" class="form-search">
                                        <label for="search">
                                ...
                                <form action="{{ route('artikel.set_banner_home') }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <section class="mt-4">
                                        <div class="card mb-4">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    <input type="checkbox" name="banner_home[]" value="{{ $artikel->id }}" 
                                    ...
                                    <div class="mt-3">
                                        <button type="submit" class="btn btn-success">Simpan Banner Home</button>
                                    </div>
                                </form>
                            </main>
                        </div>
