...
<div class="ml-sidebar">
    <nav class="navbar navbar-custom">
        <span class="title-page">Trending Article</span>
                        ...
                        <div class="container">
                            <main class="d-flex flex-column gap-3 grow">
                                <section class="d-flex gap-2 items-center justify-content-between">
                                    <div style="color: red">1. Centang kotak di samping artikel yang ingin Anda pilih sebagai artikel trending. <br> 2. Kemudian klik simpan pilihan editor untuk menyimpan pilihan</div>
                                </section>
                                <div class="d-flex align-items-center ml-auto">
                                    <form method="GET" action="{{ url('/backoffice/trending_article') }}" class="form-search">
                                        <label for="search">
                                ...
                                <form action="{{ route('artikel.set_trending_article') }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <section class="mt-4">
                                        <div class="card mb-4">
                                                    ...
                                                    <table class="table align-items-center mb-0 table-hover">
                                                        <thead class="bg-grey1">
                                                            <tr>
                                                                ...
                                                                <th class="text-center">Trending Set</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    <input type="checkbox" name="trending_article[]" value="{{ $artikel->id }}" 
                                                                        {{ $artikel->trending_article ? 'checked' : '' }}>
                                                                </td>
                                                                <td><img src="{{ asset('storage/' . $artikel->thumbnail) }}"
                                                                        alt="Dokumentasi" class="thumbnail"></td>
                                                                <td class="text-center">{{ $artikel->category->name }}
                                                                </td>
                                                                <td class="text-center">{{ $artikel->user->name }}</td>
                                                                <td class="text-center">{{ $artikel->title }}</td>
                                                                <td class="text-center">
                                                                    {{ $artikel->short_description }}</td>
                                                                <td class="text-center">
                                                            ...
                                                            <div class="modal fade" id="contentModal_{{ $artikel->id }}"
                                                                tabindex="-1" role="dialog"
                                                                aria-labelledby="exampleModalLabel_{{ $artikel->id }}"
                                                                aria-hidden="true">
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title"
                                                                                id="exampleModalLabel_{{ $artikel->id }}">
                                                                                Konten Lengkap</h5>
                                                            ...
                                                            @empty
                                                            <tr>
                                                                <td colspan="8" class="text-center">Belum ada artikel yang publish
                                                                </td>
                                                            </tr>
                                                            @endforelse
                                                        </tbody>
                                    ...
                                    <div class="mt-3">
                                        <button type="submit" class="btn btn-success">Simpan Trending Article Set</button>
                                    </div>
                                </form>
                            </main>
                        </div>
