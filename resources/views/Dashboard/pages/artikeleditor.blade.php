        ...
        <div class="container-fluid">
            ...
            <div class="row mt-3">
                <div class="col-md-6 col-sm-6">
                    <a href="/backoffice/hidden_artikel_editor" class="card card-custom shadow-sm">
                        <div class="d-flex">
                            <div class="card-text">
                ...
                <div class="col-md-6 col-sm-6">
                    <a href="/backoffice/archived_editor" class="card card-custom shadow-sm">
                        <div class="d-flex">
                            <div class="card-text">
                        ...
                        <div class="table-responsive">
                            <table class="table align-items-center mb-0 table-hover">
                                <div class="d-flex" style="justify-content: space-between;">
                                    <h4 class="card-title text-start" style="margin-top: 4px; padding-left: 10px;">
                                        Hidden Article</h4>
                                    <a href="/backoffice/hidden_artikel_editor"
                                        style="margin-top: 6px; padding-right: 10px">view all</a>
                                </div>
                                <thead class="bg-grey1" style="background: #f8fafc">
                                    <tr>
                        ...
                        <div class="table-responsive">
                            <table class="table align-items-center mb-0 table-hover">
                                <div class="d-flex" style="justify-content: space-between;">
                                    <h4 class="card-title text-start" style="margin-top: 4px; padding-left: 10px;">
                                        Archived</h4>
                                    <a href="/backoffice/archived_editor" style="margin-top: 6px; padding-right: 10px">view
                                        all</a>
                                </div>
                                <thead class="bg-grey1" style="background: #f8fafc">
                                    <tr>
