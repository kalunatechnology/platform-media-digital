                                    ...
                                    <section class="d-flex dlex-column gap-2 mt-4">
                                        <div class="page-inner" style="width: 100%">
                                            <div id="add-data-paket" class="card">
                                                ...
                                                <div class="card-body">
                                                    <form action="{{ url('/backoffice/hidden_artikel/' . $data->id) }}" method="post" enctype="multipart/form-data">
                                                        @method('put')
                                                        @csrf
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                            ...
                                                            <div class="col-md-12" style="color: red">
                                                                *setelah anda menekan "simpan perubahan" maka artikel akan ditinjau ulang oleh admin sebelum dipublish kembali
                                                            </div>
                                                            <div class="d-flex justify-content-end mt-4">
                                                                <a href="{{ url('/backoffice/hidden_artikel_editor') }}" class="btn btn-sm bg-warning mx-1 text-black">
                                                                    Cancel
                                                                </a>
