...
<div class="ml-sidebar">
    ...
    <div class="content">
        ...
        <!-- Search Bar -->
        <form method="GET" action="{{ url('/backoffice/archived_editor') }}" class="form-search">
            <label for="search">
        ...
        <div class="keterangan">
            <p>1. Anda hanya bisa melihat daftar archived dari user (author).  <br>
                2. Hanya user (author) yang berhak menentukan kapan artikel ingin dia publish ulang sesuai masa aktif artikel.</p>
        </div>
        <br><br>
